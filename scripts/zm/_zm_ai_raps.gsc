...
#define N_RAPS_SPAWN_DELAY_1P	   2.0 // Delay between spawns 1st round
#define N_RAPS_SPAWN_DELAY_2P	   1.5	// Delay between spawns 2nd round
#define N_RAPS_SPAWN_DELAY_3P	   1.0	// Delay between spawns 3rd round
#define N_RAPS_SPAWN_DELAY_4P	   0.25	// Delay between spawns thereafter
...
{	
	...
	level.n_next_raps_round = 9; //RandomIntRange( 9, 11 )
	// PI_CHANGE_END
