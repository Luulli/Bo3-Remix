...
function __init__()
{
	...
	/*level.bettyDamageMax = 2550000;
	level.bettyDamageMin = 2550000;
	level.bettyJumpHeight = 55;*/     // multiplier *= n_round * 0.15;

	level.bettyJumpHeight = 55;
	level.bettyDamageMax = 19000;
	level.bettyDamageMin = 15000;
