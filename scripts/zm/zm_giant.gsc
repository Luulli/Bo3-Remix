...
function factory_zone_init()
{
	...
	// TP South
	zm_zonemgr::add_adjacent_zone( "tp_south_zone",			"tp_south_zone",	"enter_tp_south" );
	//zm_zonemgr::add_adjacent_zone( "outside_south_zone",			"outside_south_zone",	"enter_tp_south" );
