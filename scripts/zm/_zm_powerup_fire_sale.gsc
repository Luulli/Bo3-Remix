...
{
	if( level.zombie_vars["zombie_powerup_fire_sale_on"] == true || IS_TRUE(level.disable_firesale_drop))
	{
		return false;
	}
	if (level.chest_moves < 1 && level.round_number >= 5 && level.script !== "zm_prototype")
	{
		return true;
	}
	return false;
